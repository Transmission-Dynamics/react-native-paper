...
declare const SegmentedButtonItem: ({ checked, accessibilityLabel, disabled, style, labelStyle, showSelectedCheck, checkedColor, uncheckedColor, rippleColor: customRippleColor, icon, testID, label, onPress, segment, density, theme: themeOverrides, adjustsFontSizeToFit, labelMaxFontSizeMultiplier, }: Props) => React.JSX.Element;
